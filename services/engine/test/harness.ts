/**
 * In-process Postgres (PGlite) for migration and RLS tests.
 *
...
import { LOCAL_STUBS_DIR, applyMigrations } from '../src/db/migrations.js';
import type { MigrationResult } from '../src/db/migrations.js';
import type { QueryResult, SqlExecutor } from '../src/db/executor.js';
